          ...
          <div className="top">
            ...
            <div className="top-2">
              ...
              <p>
                ...
                данные на нашем сайте самостоятельно! Раньше нужно было звонить
                и вызывать агента для оформления полиса. Сейчас, с вводом
                электроного полиса, ситуация на рынке изменилась. По телефону
                полис не оформляется. Нужно писать в Вайбер или оформлять
                самостоятельно.
              </p>
            </div>
          </div>
          ...
          <div className="bottom">
            ...
            <div className="bottom-2">
              ...
              <div className="bottom-2-2">
                О нас <br /> Контакты <br /> Оплата и доставка Юридическая
                Гарантия <br /> Публичный договор
              </div>
            </div>
            ...
            <div className="bottom-4">
              <div className="bottom-4-1">
                Квартира и дом <br /> От Короновируса <br /> Страхование
                туристов <br /> Ассистанс <br />
                Здоровье
              </div>
            </div>
            <div className="bottom-5">
              ...
              <div className="bottom-5-4">
                ответим в течении 5 минут с 9 до 21 оформим полис в течении 5
                минут с 10 до 18
              </div>
            </div>
          </div>
