    ...
    <div className="section-2-container">
      ...
      <div className="right">
        ...
        <div className="right-2">
          Заказывайте полис «Автоцивилки» онлайн <span>через месенджеры</span>
        </div>
        ...
        <div className="right-4">
          ...
          <Icon buttonType={"viberLong"}><SiViber className="viberCss"/> Viber</Icon>
        </div>
        ...
        <div className="right-8">
          <Button buttonType={"memberForm"}>Заполнить форму <AiOutlineDoubleRight className="memberCss"/></Button>
        </div>
      </div>
    </div>
  );
